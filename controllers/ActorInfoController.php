...
class ActorInfoController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/actorinfolist", [PermissionMiddleware::class], "list.actor_info")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "ActorInfoList");
    }
}
