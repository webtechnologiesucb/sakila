...
class FilmList2Controller extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/filmlist2list", [PermissionMiddleware::class], "list.film_list2")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "FilmList2List");
    }
}
