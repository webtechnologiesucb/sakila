...
class CityAdd extends City
{
    ...
    // CSS class/style
    public $CurrentPageName = "cityadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "cityview") {
    ...
    protected function getAddRow()
    {
        ...
        // country_id
        $this->country_id->setDbValueDef($rsnew, $this->country_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['country_id'])) { // country_id
            $this->country_id->setFormValue($row['country_id']);
        }
