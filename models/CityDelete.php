...
class CityDelete extends City
{
    ...
    // CSS class/style
    public $CurrentPageName = "citydelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("citylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("citylist"); // Return to list
                return;
            }
        }
