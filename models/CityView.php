...
class CityView extends City
{
    ...
    // CSS class/style
    public $CurrentPageName = "cityview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("city_id") ?? Route("city_id")) !== null) {
            ...
            $this->RecKey["city_id"] = $this->city_id->QueryStringValue;
        } elseif (Post("city_id") !== null) {
            $this->city_id->setFormValue(Post("city_id"));
            $this->RecKey["city_id"] = $this->city_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->city_id->setQueryStringValue($keyValue);
            $this->RecKey["city_id"] = $this->city_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "citylist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "citylist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
