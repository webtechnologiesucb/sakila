 ...
 * Page class
 */
class CountryDelete extends Country
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CountryDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "countrydelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("countrylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("countrylist"); // Return to list
                return;
            }
        }
