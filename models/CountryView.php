...
class CountryView extends Country
{
    ...
    // Page object name
    public $PageObjName = "CountryView";
    ...
    // CSS class/style
    public $CurrentPageName = "countryview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("country_id") ?? Route("country_id")) !== null) {
            $this->RecKey["country_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("country_id") ?? Route("country_id")) !== null) {
            ...
            $returnUrl = "countrylist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "countrylist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
