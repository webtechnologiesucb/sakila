...
/**
 * Table class for customer_list
 */
class CustomerList2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "customer_list";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->notes->Nullable = false; // NOT NULL field
        $this->notes->Required = true; // Required field
        $this->notes->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "customer_list";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("customerlist2list");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "customerlist2view" => $Language->phrase("View"),
            "customerlist2edit" => $Language->phrase("Edit"),
            "customerlist2add" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "CustomerList2View",
            Config("API_ADD_ACTION") => "CustomerList2Add",
            Config("API_EDIT_ACTION") => "CustomerList2Edit",
            Config("API_DELETE_ACTION") => "CustomerList2Delete",
            Config("API_LIST_ACTION") => "CustomerList2List",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("customerlist2view", $parm);
        } else {
            $url = $this->keyUrl("customerlist2view", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "customerlist2add?" . $parm;
        } else {
            $url = "customerlist2add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("customerlist2edit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("customerlist2list", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("customerlist2add", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("customerlist2list", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("customerlist2delete", $parm);
        }
    }
