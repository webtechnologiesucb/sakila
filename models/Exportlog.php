...
/**
 * Table class for exportlog
 */
class Exportlog extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "exportlog";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("exportloglist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "exportlogview" => $Language->phrase("View"),
            "exportlogedit" => $Language->phrase("Edit"),
            "exportlogadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ExportlogView",
            Config("API_ADD_ACTION") => "ExportlogAdd",
            Config("API_EDIT_ACTION") => "ExportlogEdit",
            Config("API_DELETE_ACTION") => "ExportlogDelete",
            Config("API_LIST_ACTION") => "ExportlogList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("exportlogview", $parm);
        } else {
            $url = $this->keyUrl("exportlogview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("exportlogedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("exportloglist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("exportlogadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("exportloglist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("exportlogdelete", $parm);
        }
    }
