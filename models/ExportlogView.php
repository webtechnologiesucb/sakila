 ...
 * Page class
 */
class ExportlogView extends Exportlog
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ExportlogView";
    ...
    // CSS class/style
    public $CurrentPageName = "exportlogview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("FileId") ?? Route("FileId")) !== null) {
            ...
            $this->RecKey["FileId"] = $this->FileId->QueryStringValue;
        } elseif (Post("FileId") !== null) {
            $this->FileId->setFormValue(Post("FileId"));
            $this->RecKey["FileId"] = $this->FileId->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->FileId->setQueryStringValue($keyValue);
            $this->RecKey["FileId"] = $this->FileId->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "exportloglist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "exportloglist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
