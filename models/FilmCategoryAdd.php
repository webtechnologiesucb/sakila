 ...
 * Page class
 */
class FilmCategoryAdd extends FilmCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FilmCategoryAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "filmcategoryadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("filmcategorylist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "filmcategorylist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "filmcategoryview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "filmcategorylist") {
                            ...
                            $returnUrl = "filmcategorylist"; // Return list page content
                        }
                    }
            ...
            if ($curVal != "") {
                ...
                if ($this->category_id->EditValue === null) { // Lookup from database
                    ...
                    if ($ari > 0) { // Lookup values found
                        ...
                        $this->category_id->EditValue = HtmlEncode(FormatNumber($this->category_id->CurrentValue, $this->category_id->formatPattern()));
                    }
                }
            } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("filmcategorylist"), "", $this->TableVar, true);
