 ...
 * Page class
 */
class FilmCategoryEdit extends FilmCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FilmCategoryEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "filmcategoryedit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("category_id") ?? Key(1) ?? Route(3)) !== null) {
