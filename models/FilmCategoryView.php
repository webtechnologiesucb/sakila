 ...
 * Page class
 */
class FilmCategoryView extends FilmCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FilmCategoryView";
    ...
    // CSS class/style
    public $CurrentPageName = "filmcategoryview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("film_id") ?? Route("film_id")) !== null) {
            ...
            $returnUrl = "filmcategorylist"; // Return to list
        }
        if (($keyValue = Get("category_id") ?? Route("category_id")) !== null) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "filmcategorylist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
