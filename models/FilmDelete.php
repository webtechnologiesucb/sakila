...
class FilmDelete extends Film
{
    ...
    // CSS class/style
    public $CurrentPageName = "filmdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("filmlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("filmlist"); // Return to list
                return;
            }
        }
