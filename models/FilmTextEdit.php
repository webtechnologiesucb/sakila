 ...
 * Page class
 */
class FilmTextEdit extends FilmText
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FilmTextEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "filmtextedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("filmtextlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "filmtextlist") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "filmtextlist") {
                            ...
                            $returnUrl = "filmtextlist"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function editRow()
    {
        ...
        // Check field with unique index (film_id)
        if ($this->film_id->CurrentValue != "") {
            $filterChk = "(`film_id` = " . AdjustSql($this->film_id->CurrentValue, $this->Dbid) . ")";
            ...
            if ($rsChk->fetch()) {
                $idxErrMsg = str_replace("%f", $this->film_id->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->film_id->CurrentValue, $idxErrMsg);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("filmtextlist"), "", $this->TableVar, true);
        $pageId = "edit";
