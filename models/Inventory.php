...
class Inventory extends DbTable
{
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "inventory";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->inventory_id->setDbValue($conn->lastInsertId());
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['inventory_id']) && !EmptyValue($this->inventory_id->CurrentValue)) {
                $rs['inventory_id'] = $this->inventory_id->CurrentValue;
            }
        }
    ...
    {
        $keys = [];
        $val = $current ? $this->inventory_id->CurrentValue : $this->inventory_id->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->inventory_id->CurrentValue = $keys[0];
            } else {
                $this->inventory_id->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            ...
            $val = !EmptyValue($this->inventory_id->OldValue) && !$current ? $this->inventory_id->OldValue : $this->inventory_id->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("inventorylist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "inventoryview" => $Language->phrase("View"),
            "inventoryedit" => $Language->phrase("Edit"),
            "inventoryadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "InventoryView",
            Config("API_ADD_ACTION") => "InventoryAdd",
            Config("API_EDIT_ACTION") => "InventoryEdit",
            Config("API_DELETE_ACTION") => "InventoryDelete",
            Config("API_LIST_ACTION") => "InventoryList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("inventoryview", $parm);
        } else {
            $url = $this->keyUrl("inventoryview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("inventoryedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("inventorylist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("inventoryadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("inventorylist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("inventorydelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"inventory_id\":" . VarToJson($this->inventory_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->inventory_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->inventory_id->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("inventory_id") ?? Route("inventory_id")) !== null) {
                $arKeys[] = $keyValue;
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'inventory');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'inventory', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'inventory', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'inventory', $fldname, $key, $oldvalue);
            }
        }
    }
