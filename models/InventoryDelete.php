 ...
 * Page class
 */
class InventoryDelete extends Inventory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "InventoryDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "inventorydelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("inventorylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("inventorylist"); // Return to list
                return;
            }
        }
