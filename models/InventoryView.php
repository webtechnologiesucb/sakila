...
class InventoryView extends Inventory
{
    ...
    // Page object name
    public $PageObjName = "InventoryView";
    ...
    // CSS class/style
    public $CurrentPageName = "inventoryview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("inventory_id") ?? Route("inventory_id")) !== null) {
            $this->RecKey["inventory_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("inventory_id") ?? Route("inventory_id")) !== null) {
            ...
            $returnUrl = "inventorylist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "inventorylist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
