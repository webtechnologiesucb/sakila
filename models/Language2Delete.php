 ...
 * Page class
 */
class Language2Delete extends Language2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Language2Delete";
    ...
    // CSS class/style
    public $CurrentPageName = "language2delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("language2list"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("language2list"); // Return to list
                return;
            }
        }
