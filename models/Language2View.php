 ...
 * Page class
 */
class Language2View extends Language2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Language2View";
    ...
    // CSS class/style
    public $CurrentPageName = "language2view";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("language_id") ?? Route("language_id")) !== null) {
            $this->RecKey["language_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("language_id") ?? Route("language_id")) !== null) {
            ...
            $this->RecKey["language_id"] = $this->language_id->QueryStringValue;
        } elseif (Post("language_id") !== null) {
            $this->language_id->setFormValue(Post("language_id"));
            $this->RecKey["language_id"] = $this->language_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->language_id->setQueryStringValue($keyValue);
            $this->RecKey["language_id"] = $this->language_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "language2list"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "language2list"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
