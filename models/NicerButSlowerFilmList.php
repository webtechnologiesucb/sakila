...
/**
 * Table class for nicer_but_slower_film_list
 */
class NicerButSlowerFilmList extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "nicer_but_slower_film_list";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->rating->Lookup = new Lookup($this->rating, 'nicer_but_slower_film_list', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
            default:
                $this->rating->Lookup = new Lookup($this->rating, 'nicer_but_slower_film_list', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "nicer_but_slower_film_list";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("nicerbutslowerfilmlistlist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "nicerbutslowerfilmlistview" => $Language->phrase("View"),
            "nicerbutslowerfilmlistedit" => $Language->phrase("Edit"),
            "nicerbutslowerfilmlistadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "nicerbutslowerfilmlistlist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "NicerButSlowerFilmListView",
            Config("API_ADD_ACTION") => "NicerButSlowerFilmListAdd",
            Config("API_EDIT_ACTION") => "NicerButSlowerFilmListEdit",
            Config("API_DELETE_ACTION") => "NicerButSlowerFilmListDelete",
            Config("API_LIST_ACTION") => "NicerButSlowerFilmListList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("nicerbutslowerfilmlistview", $parm);
        } else {
            $url = $this->keyUrl("nicerbutslowerfilmlistview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "nicerbutslowerfilmlistadd?" . $parm;
        } else {
            $url = "nicerbutslowerfilmlistadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("nicerbutslowerfilmlistedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("nicerbutslowerfilmlistlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("nicerbutslowerfilmlistadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("nicerbutslowerfilmlistlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("nicerbutslowerfilmlistdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "NicerButSlowerFilmListList";
