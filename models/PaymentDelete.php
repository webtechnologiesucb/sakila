 ...
 * Page class
 */
class PaymentDelete extends Payment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "paymentdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("paymentlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("paymentlist"); // Return to list
                return;
            }
        }
