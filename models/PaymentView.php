...
class PaymentView extends Payment
{
    ...
    // Page object name
    public $PageObjName = "PaymentView";
    ...
    // CSS class/style
    public $CurrentPageName = "paymentview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("payment_id") ?? Route("payment_id")) !== null) {
            $this->RecKey["payment_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("payment_id") ?? Route("payment_id")) !== null) {
            ...
            $returnUrl = "paymentlist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "paymentlist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
