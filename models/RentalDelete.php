 ...
 * Page class
 */
class RentalDelete extends Rental
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RentalDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "rentaldelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("rentallist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("rentallist"); // Return to list
                return;
            }
        }
