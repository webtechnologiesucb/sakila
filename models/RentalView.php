 ...
 * Page class
 */
class RentalView extends Rental
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "rentalview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("rental_id") ?? Route("rental_id")) !== null) {
            $this->RecKey["rental_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("rental_id") ?? Route("rental_id")) !== null) {
            ...
            $this->RecKey["rental_id"] = $this->rental_id->QueryStringValue;
        } elseif (Post("rental_id") !== null) {
            $this->rental_id->setFormValue(Post("rental_id"));
            $this->RecKey["rental_id"] = $this->rental_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->rental_id->setQueryStringValue($keyValue);
            $this->RecKey["rental_id"] = $this->rental_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "rentallist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "rentallist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
