 ...
 * Page class
 */
class StaffDelete extends Staff
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StaffDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "staffdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("stafflist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("stafflist"); // Return to list
                return;
            }
        }
