...
class StoreAdd extends Store
{
    ...
    // CSS class/style
    public $CurrentPageName = "storeadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "storeview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->manager_staff_id->CurrentValue != "") { // Check field with unique index
            $filter = "(`manager_staff_id` = " . AdjustSql($this->manager_staff_id->CurrentValue, $this->Dbid) . ")";
    ...
    protected function getAddRow()
    {
        ...
        // manager_staff_id
        $this->manager_staff_id->setDbValueDef($rsnew, $this->manager_staff_id->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['manager_staff_id'])) { // manager_staff_id
            $this->manager_staff_id->setFormValue($row['manager_staff_id']);
        }
