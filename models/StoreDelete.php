 ...
 * Page class
 */
class StoreDelete extends Store
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "StoreDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "storedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("storelist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("storelist"); // Return to list
                return;
            }
        }
