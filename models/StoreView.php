...
class StoreView extends Store
{
    ...
    // CSS class/style
    public $CurrentPageName = "storeview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("store_id") ?? Route("store_id")) !== null) {
            ...
            $returnUrl = "storelist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "storelist"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
