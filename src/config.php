...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/Sakila.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-gray", // CSS class(es) for sidebar
    "NAVBAR_CLASS" => "main-header navbar navbar-expand navbar-gray navbar-dark border-bottom-0", // CSS class(es) for navbar
    ...
    "AES_ENCRYPTION_KEY" => "TZyFmxupNh4b3mhVbKA/SdSbmgWlMEzpiOdER4VOrdU=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\Sakila\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\Sakila\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-5926973f-f695-4637-b16d-5acd7449bf12", // Export folder
    "EXPORT_LOG_DBID" => "DB", // DB ID
    "EXPORT_LOG_TABLE_NAME" => "exportlog", // Table name
    "EXPORT_LOG_TABLE_VAR" => "exportlog", // Table var
    ...
    "USER_TABLE_NAME" => "staff",
    "USER_TABLE_ENTITY_CLASS" => Entity\Staff::class,
