...
<span id="el_customer_store_id">
    <select
        ...
        data-select2-id="fcustomeradd_x_store_id"
        data-table="customer"
...
loadjs.ready("fcustomeradd", function() {
    var options = { name: "x_store_id", selectId: "fcustomeradd_x_store_id" };
    if (fcustomeradd.lists.store_id?.lookupOptions.length) {
        options.data = { id: "x_store_id", form: "fcustomeradd" };
    } else {
        options.ajax = { id: "x_store_id", form: "fcustomeradd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_customer_address_id">
    <select
        ...
        data-select2-id="fcustomeradd_x_address_id"
        data-table="customer"
...
<script>
loadjs.ready("fcustomeradd", function() {
    var options = { name: "x_address_id", selectId: "fcustomeradd_x_address_id" };
    if (fcustomeradd.lists.address_id?.lookupOptions.length) {
        options.data = { id: "x_address_id", form: "fcustomeradd" };
    } else {
        options.ajax = { id: "x_address_id", form: "fcustomeradd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<script>
loadjs.ready(["fcustomeradd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcustomeradd", "x_create_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fcustomeradd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcustomeradd", "x_last_update", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php if (!$Page->isConfirm()) { // Confirm page ?>
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcustomeradd" data-ew-action="set-action" data-value="confirm"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
...
<?php } ?>
<?php } else { ?>
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fcustomeradd"><?= $Language->phrase("ConfirmBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="submit" form="fcustomeradd" data-ew-action="set-action" data-value="cancel"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
