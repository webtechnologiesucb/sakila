...
?>
<main class="view">
<form name="ffilm_categoryview" id="ffilm_categoryview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->film_id->Visible) { // film_id ?>
    <tr id="r_film_id"<?= $Page->film_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_film_category_film_id"><?= $Page->film_id->caption() ?></span></td>
...
<?php if ($Page->category_id->Visible) { // category_id ?>
    <tr id="r_category_id"<?= $Page->category_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_film_category_category_id"><?= $Page->category_id->caption() ?></span></td>
...
<?php if ($Page->last_update->Visible) { // last_update ?>
    <tr id="r_last_update"<?= $Page->last_update->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_film_category_last_update"><?= $Page->last_update->caption() ?></span></td>
