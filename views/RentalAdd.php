...
$Page->showMessage();
?>
<form name="frentaladd" id="frentaladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script>
loadjs.ready(["frentaladd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("frentaladd", "x_rental_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_rental_inventory_id">
    <select
        ...
        data-select2-id="frentaladd_x_inventory_id"
        data-table="rental"
...
<script>
loadjs.ready("frentaladd", function() {
    var options = { name: "x_inventory_id", selectId: "frentaladd_x_inventory_id" };
    if (frentaladd.lists.inventory_id?.lookupOptions.length) {
        options.data = { id: "x_inventory_id", form: "frentaladd" };
    } else {
        options.ajax = { id: "x_inventory_id", form: "frentaladd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_rental_customer_id">
    <select
        ...
        data-select2-id="frentaladd_x_customer_id"
        data-table="rental"
...
<script>
loadjs.ready("frentaladd", function() {
    var options = { name: "x_customer_id", selectId: "frentaladd_x_customer_id" };
    if (frentaladd.lists.customer_id?.lookupOptions.length) {
        options.data = { id: "x_customer_id", form: "frentaladd" };
    } else {
        options.ajax = { id: "x_customer_id", form: "frentaladd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
loadjs.ready(["frentaladd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("frentaladd", "x_return_date", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_rental_staff_id">
    <select
        ...
        data-select2-id="frentaladd_x_staff_id"
        data-table="rental"
...
<script>
loadjs.ready("frentaladd", function() {
    var options = { name: "x_staff_id", selectId: "frentaladd_x_staff_id" };
    if (frentaladd.lists.staff_id?.lookupOptions.length) {
        options.data = { id: "x_staff_id", form: "frentaladd" };
    } else {
        options.ajax = { id: "x_staff_id", form: "frentaladd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
loadjs.ready(["frentaladd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("frentaladd", "x_last_update", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php if (!$Page->isConfirm()) { // Confirm page ?>
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="frentaladd" data-ew-action="set-action" data-value="confirm"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="frentaladd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
<?php } else { ?>
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="frentaladd"><?= $Language->phrase("ConfirmBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="submit" form="frentaladd" data-ew-action="set-action" data-value="cancel"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
