...
<script>
loadjs(ew.PATH_BASE + "css/<?= CssFile("tempus-dominus.css") ?>?v=24.13.0");
ew.ready("head", [
...
<script>
// Load chart *.js
loadjs(ew.PATH_BASE + "js/chart.umd.js?v=24.13.0", "chartjs");
ew.ready(["chartjs", "luxon"], [
    ew.PATH_BASE + "js/chartjs-adapter-luxon.umd.min.js?v=24.13.0",
    ew.PATH_BASE + "js/chartjs-plugin-annotation.min.js?v=24.13.0",
    ew.PATH_BASE + "js/chartjs-plugin-datalabels.min.js?v=24.13.0",
    ew.PATH_BASE + "js/chartjs-plugin-stacked100.js?v=24.13.0",
    ew.PATH_BASE + "js/ewchart.js?v=24.13.0",
], "chart");
</script>
<!-- Navbar -->
